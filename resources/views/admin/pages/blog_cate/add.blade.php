...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <form action="{{route('blog-cate.store')}}" method="POST" role="from" enctype="multipart/form-data">
                        @csrf
                        <legend>THÊM MỚI BLOG CHO DANH MỤC</legend>
                        <hr>
                        ...
                        <div class="form-group">
                            <label for=""><b>Chọn danh mục blog</b></label>
