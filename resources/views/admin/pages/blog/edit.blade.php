...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <form action="{{route('blog.update',$blog->id)}}" method="POST" role="from" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id=""
                                placeholder="Nhập tên name" name="name" value="{{$blog->name}}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control @error('name') is-invalid @enderror" id=""
                                placeholder="Nhập tên name" name="file" value="{{$blog->image}}">
                                <img src="{{url('upload')}}/{{$blog->image}}" alt="upload/{{$blog->image}}"
                                            width="100px">
