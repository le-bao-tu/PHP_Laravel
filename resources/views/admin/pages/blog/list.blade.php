...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        @endif
        <legend >DANH SÁCH DANH MỤC BLOG</legend>
        <table style="background-color:#;text-align:center;color:" border="1px" class="table">
            <thead>
                <tr>
                    <th style="text-align:center">STT</th>
                    <th style="text-align:center">Tên Danh Mục Blog</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('blog.edit',$value->id)}}" title="Sửa" class="btn btn-primary">Edit</a>
                    </td>
                    <td>
