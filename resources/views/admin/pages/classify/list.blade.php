        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    ...
                    @endif
                    <legend>DANH SÁCH PHÂN LOẠI</legend>

                    <div class="container">
                        <div class="row">

                            <label for="">Tìm kiếm Phân loại</label>
                    ...
                    <table style="background-color:#;text-align:center;margin-top:30px" border="1px" class="table">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('classify.edit',$value->id)}}" title="Sửa"
                                        class="btn btn-primary">Edit</a>
                                </td>
                                <td>
                                    <form action="{{route('classify.destroy',$value->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
