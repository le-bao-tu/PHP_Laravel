...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <form action="{{route('product.update',$pro->id)}}"  method="POST" role="from" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id=""
                                placeholder="Nhập tên name" name="name" value="{{$pro->name}}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('price') is-invalid @enderror" id=""
                                placeholder="Nhập gía sản phẩm" name="price" value="{{$pro->price}}">
                            @error('price')
                            <div class="alert alert-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('sale_price') is-invalid @enderror" id=""
                                placeholder="Nhập giá khuyến mãi" name="sale_price" value="{{$pro->sale_price}}">
                            @error('sale_price')
                            <div class="alert alert-danger">{{$message}}</div>
                            @enderror
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control " id="" placeholder="" name="file"
                                            value="{{$pro->image}}">
                                        <img src="{{url('upload')}}/{{$pro->image}}" alt="upload/{{$pro->image}}"
                                            width="100px">
                                    </div>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" id="input" class="form-control" required="required">
                                ...
                                <option value="{{$value->id}}" {{($value->id == $pro->category_id)?'selected':''}}>
                                    {{$value->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="brands_id" id="hung" class="form-control" required="required">
                                <option value="">Thương hiệu sản phẩm </option>
                                    ...
                                    <option value="{{$cate->id}}" {{(in_array($cate->id,$brands_id))?'selected':''}}>{{$cate->name}}</option>
                                    @endforeach
                            </select>
                        </div>
                            ...
                            <div class="checkbox">
                                ...
                                <label>
                                    <input type="checkbox" value="{{$value->id}}" name="colors[]"
                                        {{(in_array($value->id,$color_product))?'checked':''}}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="description"
                                class="form-control @error('description') is-invalid @enderror" rows="5" id="comment"
