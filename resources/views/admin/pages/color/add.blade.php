...
<div class="content-wrapper">
    ...
    <div class="row">
    <div class="col-md-6">
    <form action="{{route('color.store')}}" method="POST" role="from">
                <legend >THÊM MỚI MÀU</legend>
                @csrf
                <hr>
                    <div class="form-group">
                        <label  for=""><b>Tên Màu</b></label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="" placeholder="Nhập tên màu"  name="name" >
                        @error('name')
                        ...
                        <input type="color" class="form-control" id="" placeholder="Nhập tên name"  name="code_color" >
                        @error('code_color')
                        <div  class="alert alert-danger">{{$message}}</div>
                        @enderror
                        </div>
